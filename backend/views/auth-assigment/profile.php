                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile ">
                        <div class="mt-2 profile-name">
                            <h5 class="font-weight-bold mb-0">Ulug'bek Samegjonov</h5>
                        ...
                        <div class="mt-2">
                            ...
                            <h6 class="font-weight-bold">99 854 27 47 </h6>
                            <p  class="text-muted mb-0">Ota - Onalar telefoni: <span class="font-weight-bold text-dark">- begzod</span></p>
                            <h6 class="font-weight-bold">99 854 27 47 </h6>
                        ...
                        <div class="mt-3 d-flex justify-content-between">
                            <div>
                                <button type="button" class="btn btn-outline-primary rounded-pill py-0"><i class=" fas fa-inbox mr-1" style="color: #58ace4;"></i>Guruhga qo'shish</button>
                            </div>
                        ...
                        <div class="mt-3 position-absolute" style="top: 0; right: 10px;">
                            <div class="d-flex flex-column">
                                ...
                                <div class="pt-2">
                                    <button type="button" class="btn btn-outline-danger rounded-circle px-2 py-1 "><i class=" far fa-trash-alt" style="color: #ff3b3b;"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
