                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile ">
                        <div class="mt-2 profile-name">
                            <h5 class="font-weight-bold mb-0  btn btn-dark"><?= $model->course->name?></h5>
                        </div>
                        <div class="mt-2">
                            <h6 class="text-muted mb-0"><?= $model->group_name?> * Teacher name</h6>
                            <br>

                            <h6  class="text-muted mb-0">Narx: &nbsp; &nbsp; <?= $model->price?>  UZS </h6>
                            <h6  class="text-muted mb-0">Vaqt: <br>
                                <?php
                                $decoded = json_decode($model->days, true);
                                echo is_array($decoded) ? implode(', ', $decoded) : '' ;
                                ?>
                                * <?=$model->hour?>
                                 </h6>
                            <br>
                            <h6  class="text-muted mb-0">Xonalar: &nbsp; &nbsp; 1-xona </h6>
                            <h6  class="text-muted mb-0">Mashg'ulotlar sanasi:<br> <?= $model->lesson_start .' ' . $model->lesson_end?>  </h6>
